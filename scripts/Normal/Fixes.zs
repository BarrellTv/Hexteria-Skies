...
recipes.addShaped(<mysticalagriculture:constantan_seeds>, [[<tp:lapis_ingot>, <mysticalagriculture:crafting:3>, <tp:lapis_ingot>], [<mysticalagriculture:crafting:3>, <mysticalagriculture:crafting:20>, <mysticalagriculture:crafting:3>], [<tp:lapis_ingot>, <mysticalagriculture:crafting:3>, <tp:lapis_ingot>]]);
...
recipes.addShaped(<mysticalagriculture:fluxed_electrum_seeds>, [[<ore:ingotElectrumFlux>, <mysticalagriculture:crafting:3>, <ore:ingotElectrumFlux>], [<mysticalagriculture:crafting:3>, <mysticalagriculture:crafting:20>, <mysticalagriculture:crafting:3>], [<ore:ingotElectrumFlux>, <mysticalagriculture:crafting:3>, <ore:ingotElectrumFlux>]]);
...
#Fluxed seed to agri
recipes.addShapeless(<mysticalagriculture:fluxed_electrum_seeds>.withTag({agri_analyzed: 0 as byte, agri_strength: 1 as byte, agri_gain: 1 as byte, agri_seed: "mysticalagriculture:fluxed_electrum_plant", agri_growth: 1 as byte}), [<mysticalagriculture:fluxed_electrum_seeds>]);
