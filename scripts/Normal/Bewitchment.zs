...
recipes.addShaped(<bewitchment:witches_cauldron>, [[<minecraft:sand>, null, <minecraft:sand>], [<ore:blockSteel>, <forge:bucketfilled>.withTag({FluidName: "silver", Amount: 1000}), <ore:blockSteel>], [<ore:blockSteel>, <ore:blockSteel>, <ore:blockSteel>]]);
