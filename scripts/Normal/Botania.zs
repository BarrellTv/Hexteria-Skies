...
recipes.addShaped(<botania:flighttiara>.withTag({}), [[<minecraft:emerald>, <minecraft:emerald>, <minecraft:emerald>], [<minecraft:emerald>, <botania:storage:4>, <minecraft:emerald>], [<actuallyadditions:item_wings_of_the_bats>, <ore:bRedString>, <actuallyadditions:item_wings_of_the_bats>]]);
